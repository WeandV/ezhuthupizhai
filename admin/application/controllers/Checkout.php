    ...
    public function place_order()
    {
        ...
        try {
            ...
            if ($user_id_from_auth_context !== null) {
                ...
                // FIX: Correctly handle the result from the User_model
            ...
            // This line is now redundant as we handle the update inside the user creation logic
            // if ($user_id !== null) {
            ...
            // --- END OF CORRECTED INVENTORY UPDATE LOGIC ---
            ...
            echo json_encode(['success' => false, 'message' => $e->getMessage()]); // Exposing the real error
        }
    }
