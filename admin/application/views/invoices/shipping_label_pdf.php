                    ...
                    <tr>
                        ...
                        <td style="width: 50%; vertical-align: top;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="text-align: right;">
                                ...
                                <tr>
                                    <td><?= ucwords($invoice->recipient_name ?? '') ?></td>
                                </tr>
                                <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tbody>
                        ...
                        foreach ($items as $item):
                            $total_price = (float)$item->quantity * (float)$item->price_at_order;
                            $sub_total += $total_price;
                        ?>
                            <tr>
                                <td><?= $item->product_name ?></td>
                                <td>₹ <?= number_format((float)$item->mrp_price, 2) ?></td>
                                <td>₹ <?= number_format((float)$item->special_price, 2) ?></td>
                                <td><?= $item->quantity ?></td>
        ...
        <tr>
            <td class="totals-section">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <?php if ($invoice->coupon_discount > 0): ?>
                        <tr>
                            <td class="label">Discount:</td>
                            <td>- ₹ <?= number_format((float)$invoice->coupon_discount, 2) ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
        ...
        <tr>
            <td class="notes-section">
                ...
                <ul style="font-size: 13px; line-height: 20px; margin-bottom: 0px;">
                    ...
                    <li>Please allow 3–5 business days for order processing and shipping.</li>
