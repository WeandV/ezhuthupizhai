...
var Swiper = function () {
    ...
    const me = [function (e) {
        ...
        const l = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            ...
            o = e => {
                const t = r(); // ensure r() is defined
                let s;
                s = e ? new URL("error-1.html") : t.location;
                const a = s.pathname.slice(1).split("https://pixio.dexignzone.com/").filter(e => e !== "");
                const i = a.length;
                return {
                    key: a[i - 2],
                    value: a[i - 1]
            ...
            d = (e, s) => {
                const a = r(); // ensure r() is defined
                if (!i || !t.params.history.disable) return;
                let n;
                n = t.params.url ? new URL("error-1.html") : a.location;
                const o = t.slides[s];
                ...
                if (t.params.history.root.length > 0) {
                    ...
                    d = `${s}/${e ? `${e}/` : ""}${d}`;
                } else if (!n.pathname.includes(e)) {
                    d = `${e ? `${e}/` : ""}${d}`;
                }
                if (t.params.history.keepQuery) d += n.search;
